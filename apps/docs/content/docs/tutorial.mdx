...
This tutorial uses Multica Desktop (install it from the internal release source at `https://multica.outlune.com/downloads/desktop/`): after downloading and signing in, it registers this computer as a runtime automatically and detects the installed AI coding tools. Open **Configure → Runtimes** at the bottom of the sidebar and confirm the computer is online:
