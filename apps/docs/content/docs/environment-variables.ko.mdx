...
| `MULTICA_ZENMUX_MANAGEMENT_API_KEY` | 비어 있음(수집기 비활성) | ZenMux Management API 키(콘솔 발급, 추론 키와 별개). 이 머신의 hermes 런타임을 ZenMux 계정에 연결하고 구독 쿼터 수집기를 활성화합니다. 키는 이 머신을 벗어나지 않습니다 |
