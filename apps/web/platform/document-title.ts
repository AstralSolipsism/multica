 ...
 * `Issues | Labrastro` and `Changelog | Labrastro` can never drift into two
...
export const SITE_TITLE = "Labrastro — Project Management for Human + Agent Teams";

/** Appended to every page-specific title. */
export const TITLE_SUFFIX = " | Labrastro";
