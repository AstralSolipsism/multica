...
export const metadata: Metadata = {
  ...
  // "Labrastro" rather than the long SEO <title>. `capable` renders the
  ...
  twitter: {
    ...
    // No public social account exists for this deployment, so the upstream
    // attribution handles are dropped rather than pointed somewhere wrong.
  },
  alternates: {
    canonical: "/",
  },
