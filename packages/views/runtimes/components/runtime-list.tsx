      ...
      >
        ...
        {rows.map((row) => {
          ...
          return (
            <ListGridRow
              key={row.runtime.id}
              // The quota column renders one line per window plus a reset
              // line; let a row grow past the default h-12 when it has to,
              // instead of letting the cell overflow onto the next row.
              className={
