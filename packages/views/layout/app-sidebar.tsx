  ...
  return (
      <Sidebar variant="inset">
        ...
        <SidebarFooter className="p-2">
          ...
          {/* One utility strip: the community QR entry takes the leading
              space the help trigger was leaving empty. `justify-end` keeps
              the trigger right-aligned once the entry is dismissed. */}
