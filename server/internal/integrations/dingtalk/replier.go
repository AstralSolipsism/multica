...
const (
	...
	chatStartedText         = "✅ Started a new Labrastro chat. Your next message will enter it."
	...
	issueNotMemberText = "You're not a member of this Labrastro workspace, so I can't file an issue for you. Ask a workspace admin to invite you, then send the command again."
	issueDisabledText  = "This DingTalk robot isn't connected to Labrastro (or was disconnected). Ask the agent owner or a workspace owner/admin to reconnect it."
)
...
func (r *OutboundReplier) sendBindingPrompt(ctx context.Context, inst engine.ResolvedInstallation, msg channel.InboundMessage, res engine.Result) error {
	...
	text := "👋 To start chatting with me, link your DingTalk account to Labrastro: [link your account](" +
